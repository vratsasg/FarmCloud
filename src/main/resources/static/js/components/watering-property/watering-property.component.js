                ...
                var varApiGet = WateringPropertyService.getMeasuresByProperty(devIdentifier, datefrom, dateto).then(
                    function (apd) {
                        ...
                        theMeasures.measuredata.forEach(function(measure){
                            ...
                            measure.phenomenonTimeStart = moment(parseInt(measure.phenomenonTimeStart)).utc().format('DD/MM/YY HH:mm:ss');
                            ...
                            measure.phenomenonTimeEnd = moment(parseInt(measure.phenomenonTimeEnd)).utc().format('DD/MM/YY HH:mm:ss');
                        });
